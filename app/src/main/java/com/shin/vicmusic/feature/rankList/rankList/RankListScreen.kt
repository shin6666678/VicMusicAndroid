...
fun RankListRoute(
    ...
    val recommendedRankLists = listOf(
        RecommendedRankListInfo("腾讯音乐榜", Color(0xFF42A5F5)),
        RecommendedRankListInfo("巅峰潮流榜", Color(0xFFEF5350)),
        RecommendedRankListInfo("韩国Melon榜", Color(0xFF66BB6A)),
        RecommendedRankListInfo("日本Oricon榜", Color(0xFFFFA726))
    )
        ...
        Column(
            ...
            LazyColumn(
                ...
                items(peakCharts) { item ->
                    RankListItem(rankListItemInfo = item)
                }
            }
        }
    }
